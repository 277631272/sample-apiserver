...
type BarLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.Bar, err error)
...
// List lists all Bars in the indexer.
func (s *barLister) List(selector labels.Selector) (ret []*v1beta1.Bar, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.Bar))
	})
	return ret, err
}
...
type BarNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*v1beta1.Bar, error)
...
// List lists all Bars in the indexer for a given namespace.
func (s barNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.Bar, err error) {
...
// Get retrieves the Bar from the indexer for a given namespace and name.
func (s barNamespaceLister) Get(name string) (*v1beta1.Bar, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("bar"), name)
	}
	return obj.(*v1beta1.Bar), nil
}
