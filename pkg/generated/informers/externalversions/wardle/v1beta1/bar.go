	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WardleV1beta1().Bars(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WardleV1beta1().Bars(namespace).Watch(context.TODO(), options)
			},
		},
		&wardlev1beta1.Bar{},
		resyncPeriod,
...
func (f *barInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wardlev1beta1.Bar{}, f.defaultInformer)
}

func (f *barInformer) Lister() v1beta1.BarLister {
	return v1beta1.NewBarLister(f.Informer().GetIndexer())
}
