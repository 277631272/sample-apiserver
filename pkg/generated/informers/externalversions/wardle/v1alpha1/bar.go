...
import (
	...
	v1alpha1 "git.woa.com/richardgu/sample-apisvc/pkg/generated/listers/wardle/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WardleV1alpha1().Bars(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WardleV1alpha1().Bars(namespace).Watch(context.TODO(), options)
			},
		},
		&wardlev1alpha1.Bar{},
		resyncPeriod,
...
func (f *barInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wardlev1alpha1.Bar{}, f.defaultInformer)
}
