...
func autoConvert_v1alpha1_Bar_To_wardle_Bar(in *Bar, out *wardle.Bar, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1alpha1_BarSpec_To_wardle_BarSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1alpha1_BarStatus_To_wardle_BarStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha1_Bar_To_wardle_Bar is an autogenerated conversion function.
func Convert_v1alpha1_Bar_To_wardle_Bar(in *Bar, out *wardle.Bar, s conversion.Scope) error {
	return autoConvert_v1alpha1_Bar_To_wardle_Bar(in, out, s)
}

func autoConvert_wardle_Bar_To_v1alpha1_Bar(in *wardle.Bar, out *Bar, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_wardle_BarSpec_To_v1alpha1_BarSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_wardle_BarStatus_To_v1alpha1_BarStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_wardle_Bar_To_v1alpha1_Bar is an autogenerated conversion function.
func Convert_wardle_Bar_To_v1alpha1_Bar(in *wardle.Bar, out *Bar, s conversion.Scope) error {
	return autoConvert_wardle_Bar_To_v1alpha1_Bar(in, out, s)
}

func autoConvert_v1alpha1_BarList_To_wardle_BarList(in *BarList, out *wardle.BarList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]wardle.Bar, len(*in))
		for i := range *in {
			if err := Convert_v1alpha1_Bar_To_wardle_Bar(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_v1alpha1_BarList_To_wardle_BarList is an autogenerated conversion function.
func Convert_v1alpha1_BarList_To_wardle_BarList(in *BarList, out *wardle.BarList, s conversion.Scope) error {
	return autoConvert_v1alpha1_BarList_To_wardle_BarList(in, out, s)
}

func autoConvert_wardle_BarList_To_v1alpha1_BarList(in *wardle.BarList, out *BarList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]Bar, len(*in))
		for i := range *in {
			if err := Convert_wardle_Bar_To_v1alpha1_Bar(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_wardle_BarList_To_v1alpha1_BarList is an autogenerated conversion function.
func Convert_wardle_BarList_To_v1alpha1_BarList(in *wardle.BarList, out *BarList, s conversion.Scope) error {
	return autoConvert_wardle_BarList_To_v1alpha1_BarList(in, out, s)
}
...
// Convert_v1alpha1_BarSpec_To_wardle_BarSpec is an autogenerated conversion function.
func Convert_v1alpha1_BarSpec_To_wardle_BarSpec(in *BarSpec, out *wardle.BarSpec, s conversion.Scope) error {
	return autoConvert_v1alpha1_BarSpec_To_wardle_BarSpec(in, out, s)
}
...
// Convert_wardle_BarSpec_To_v1alpha1_BarSpec is an autogenerated conversion function.
func Convert_wardle_BarSpec_To_v1alpha1_BarSpec(in *wardle.BarSpec, out *BarSpec, s conversion.Scope) error {
	return autoConvert_wardle_BarSpec_To_v1alpha1_BarSpec(in, out, s)
}

func autoConvert_v1alpha1_BarStatus_To_wardle_BarStatus(in *BarStatus, out *wardle.BarStatus, s conversion.Scope) error {
	return nil
}

// Convert_v1alpha1_BarStatus_To_wardle_BarStatus is an autogenerated conversion function.
func Convert_v1alpha1_BarStatus_To_wardle_BarStatus(in *BarStatus, out *wardle.BarStatus, s conversion.Scope) error {
	return autoConvert_v1alpha1_BarStatus_To_wardle_BarStatus(in, out, s)
}

func autoConvert_wardle_BarStatus_To_v1alpha1_BarStatus(in *wardle.BarStatus, out *BarStatus, s conversion.Scope) error {
	return nil
}

// Convert_wardle_BarStatus_To_v1alpha1_BarStatus is an autogenerated conversion function.
func Convert_wardle_BarStatus_To_v1alpha1_BarStatus(in *wardle.BarStatus, out *BarStatus, s conversion.Scope) error {
	return autoConvert_wardle_BarStatus_To_v1alpha1_BarStatus(in, out, s)
}
...
func autoConvert_v1alpha1_FlunderSpec_To_wardle_FlunderSpec(in *FlunderSpec, out *wardle.FlunderSpec, s conversion.Scope) error {
	...
	// WARNING: in.ReferenceType requires manual conversion: inconvertible types (*git.woa.com/richardgu/sample-apisvc/pkg/apis/wardle/v1alpha1.ReferenceType vs git.woa.com/richardgu/sample-apisvc/pkg/apis/wardle.ReferenceType)
	return nil
}
...
func autoConvert_wardle_FlunderSpec_To_v1alpha1_FlunderSpec(in *wardle.FlunderSpec, out *FlunderSpec, s conversion.Scope) error {
	...
	// WARNING: in.ReferenceType requires manual conversion: inconvertible types (git.woa.com/richardgu/sample-apisvc/pkg/apis/wardle.ReferenceType vs *git.woa.com/richardgu/sample-apisvc/pkg/apis/wardle/v1alpha1.ReferenceType)
	return nil
}
